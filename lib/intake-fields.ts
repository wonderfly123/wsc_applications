...
export const INTAKE_FIELDS: IntakeFieldDef[] = [
  ...
  { name: 'eventLocation', label: 'Event Location', type: 'text', required: true, clickupFieldId: 'b92b1e46-363e-4453-9888-b530ecdeefce', clickupFieldType: 'location', placeholder: 'Venue name and address', helpText: "Start typing and pick the address from the dropdown. If you're coming back to update this form, click into the field and pick it from the dropdown again.", section: 'timing', half: true, hideWhenPackage: ['Sandcastle'] },
  { name: 'loadInLocation', label: 'Vendor Load-in Location', type: 'text', required: true, clickupFieldId: '967038c5-4d18-41d5-8c63-f01bf20ece7a', clickupFieldType: 'location', placeholder: 'Where should we load in?', helpText: "Start typing and pick the address from the dropdown. If you're coming back to update this form, click into the field and pick it from the dropdown again.", section: 'timing', half: true, labelByPackage: { Sandcastle: 'Delivery Location' } },

...
export const INTAKE_FIELDS: IntakeFieldDef[] = [
  ...
  { name: 'otherGarnish', label: 'Other Garnish', type: 'text', required: false, clickupFieldId: '8de89e8b-2d7d-4269-b5cb-d8d6e6d3ab7c', clickupFieldType: 'short_text', placeholder: 'Describe the garnish', helpText: 'Tell us what garnish you\'d like.', section: 'package', half: true, showWhen: { field: 'garnish', op: '==', value: 'Other' } },
